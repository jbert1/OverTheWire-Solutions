...
sleep(0.2)
shell.send(b'git clone ssh://bandit30-git@localhost:2220/home/bandit30-git/repo\n')
sleep(1.0)
shell.send(b'yes\n')
sleep(1.0)
...
sleep(0.2)
shell.send(b'git show secret\n')
sleep(0.2)
new_password = shell.recv(8192).split(b'\r')[-3][:-3].decode()
